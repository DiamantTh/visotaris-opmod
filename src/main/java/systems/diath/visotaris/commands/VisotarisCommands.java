package systems.diath.visotaris.commands;
...
public final class VisotarisCommands {
    ...
    private static void registerAll(CommandDispatcher<FabricClientCommandSource> d,
        ...
        d.register(ClientCommandManager.literal("visotaris")
            ...
            .then(ClientCommandManager.literal("settings")
                .executes(ctx -> {
                    ...
                    mc.setScreen(new systems.diath.visotaris.config.VisotarisConfigScreen(mc.currentScreen));
                    return 1;
                })
            )
        );
