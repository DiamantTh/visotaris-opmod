...
public final class NetworkSettingsScreen extends Screen {
    ...
    public NetworkSettingsScreen(Screen parent) {
        super(Component.literal("Visotaris \u2013 Netzwerk-Einstellungen"));
        this.parent        = parent;
    ...
    public void render(GuiGraphics ctx, int mouseX, int mouseY, float delta) {
        ...
        ctx.drawString(this.font,
            Component.literal("API-Schl\u00fcssel (Bearer-Auth)"),
        ...
        ctx.drawCenteredString(this.font,
            Component.literal("\u00a77\u00c4nderungen erfordern einen Neustart des Clients."),
